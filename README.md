...
Add extras (luggage, music, water).
...
Review subtotal, delivery fee, and total.
...
Enter item weight, pickup & drop addresses.

Enable COD if needed.
...
Select a payment method (ABA, Wing, Pi Pay, TrueMoney, ACLEDA).
